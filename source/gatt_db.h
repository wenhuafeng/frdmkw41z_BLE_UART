...
PRIMARY_SERVICE_UUID128(service_wireless_uart, uuid_service_wireless_uart)
    CHARACTERISTIC_UUID128(char_uart_stream, uuid_uart_stream, (gGattCharPropWriteWithoutRsp_c))
        VALUE_UUID128_VARLEN(value_uart_stream, uuid_uart_stream, (gPermissionFlagWritable_c), gAttMaxWriteDataSize_d(gAttMaxMtu_c), 5, 0x00, 0x00, 0x00, 0x00, 0x00)
	CHARACTERISTIC_UUID128(char_interm_uart, uuid_Intermediate_wireless_uart, (gGattCharPropRead_c))
		VALUE_UUID128_VARLEN(value_interm_uart, uuid_Intermediate_wireless_uart, (gPermissionFlagReadable_c), 13, 5, 0x00, 0x00, 0x00, 0x00, 0x00)
		CCCD(cccd_interm_uart)
...
PRIMARY_SERVICE(service_battery, gBleSig_BatteryService_d)
	...
	CHARACTERISTIC(char_interm_temp, gBleSig_IntermediateTemperature_d, (gGattCharPropNotify_c | gGattCharPropRead_c))
